/* To implement a triangle and perform the following 2D transformations
...
The program should be menu driven allowing the user to choose any of the transformation. Divide the coordinate axes; display the original object and transformed object in different color or fill patterns.
